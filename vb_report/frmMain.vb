'Source code dibuat oleh Sugeng Agung Suganda
'Punya pertanyaan silahkan hubungi facebook https://facebook.com/sugandaaa
'Perkenalkan diri sebelum bertanya, saya tidak akan menjawab jika kamu tidak memiliki attitude
...
Public Class frmMain
    ...
    Sub Koneksi()
        LokasiData = "Driver={MySQL ODBC 5.3 ANSI Driver};database=vb_report;server=localhost;uid=root;pwd="
